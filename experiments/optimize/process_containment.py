"""Windows process-tree containment for the FAST runner's pending Windows port.

Production use remains disabled until the Windows CI gates have real evidence.
The low-level implementation is directly testable; it requires Windows 10+.
This contains ordinary trusted benchmark descendants, not adversarial programs.
"""
import ctypes as C
import math
import ntpath
...
# Enabling this requires a separate reviewed change after actual Windows tests.
# There is intentionally no command-line or environment-variable override.
